...
import LayersAppContent from '@/app/components/app-content/layers-app-content'
...
function LayersPage() {
  ...
  return (
    <>
      ...
      <AppContent projectData={projectData} projectDataLoading={projectDataLoading} content={<LayersAppContent id={id} />}/>
      </div>
      )}
    </>
  )
