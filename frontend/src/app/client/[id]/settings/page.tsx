...
import SettingsAppContent from '@/app/components/app-content/settings-app-content'
...
function SettingsPage() {
  ...
  return (
    <>
      ...
      <AppContent projectData={projectData} projectDataLoading={projectDataLoading} content={<SettingsAppContent id={id} />}/>
      </div>
      )}
    </>
  )
